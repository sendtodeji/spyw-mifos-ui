...
$sql = sprintf('select txndate, txntype, debit, credit, account_id, customer_id from v_savings_stmt');
...
$scdg->display(false);
$scGrid = $scdg->get_display(FALSE);
$scdg->display_script_includeonce();
?>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs"><?php echo $_SESSION['display_name']; ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <small>Member since <?php echo $_SESSION['member_since']; ?> </small>
                                    </p>
                                </li>
                    ...
                    <div class="col-md-9">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#activity" data-toggle="tab">Monthly</a></li>
                                <li><a href="#timeline" data-toggle="tab">Share Capital</a></li>
